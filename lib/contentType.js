...
ContentType.prototype.getFromExt = function (ext) {
    ...
    else throw new DataError({ message: "The extension: " + ext + " is not supported" });
};

exports = module.exports = new ContentType();