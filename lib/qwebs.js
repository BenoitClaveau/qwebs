...
function Router () {
    ...
    this.postList = [];
    this.assets = assets;
    this.TokenService = require('./services/tokenService');
...
Router.prototype = {
    init: function (options) {
        ...
        return Q.try(function () {
            if (options.folder) global.folder = options.folder;
            if (options.debug !== null) global.debug = options.debug;
            if (options.verbose !== null) global.verbose = options.verbose;
            if (options.secret !== null) global.secret = options.secret;
            
            return assets.load(global.folder).then(function () {  //load & create assets
...
Get.prototype = {
    ...
    register: function (controller, viewName) {
        ...
        if (global.verbose) console.log(this.route, viewName);
        return this;
    },
