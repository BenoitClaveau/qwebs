    ...
    request(options) {
        return new Promise((resolve, reject) => {
            ...
            request(options, (err, httpResponse, body) => {
                if (err) reject(err);
                else if (httpResponse.statusCode < 200 || httpResponse.statusCode > 299) reject(new WebError({ statusCode: httpResponse.statusCode, message: httpResponse.statusMessage, data: { response: httpResponse, body: body }}));
