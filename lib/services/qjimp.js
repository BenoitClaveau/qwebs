...
class QJimp {
    ...
    clone(image) {
        return Promise.resolve().then(() => {
            if (!image) throw new UndefinedError("Image");
            return image.clone();
        });
    };
    ...
    toBuffer(image, contentType) {
        return new Promise((resolve, reject) => {
            if (!contentType) reject(new UndefinedError("ContentType"));
    ...
    resize(image, width, height) {
        return Promise.resolve().then(() => {  
            if (!image) throw new UndefinedError("Image");
            if (!width) throw new UndefinedError("Width");
            if (!height) throw new UndefinedError("Height");
    ...
    crop(image, left, top, width, height) {
        return Promise.resolve().then(() => {  
            if (!image) throw new UndefinedError("Image");
            if (left == null) throw new UndefinedError("Left");
            if (top == null) throw new UndefinedError("Top");
            if (width == null) throw new UndefinedError("Width");
            if (height == null) throw new UndefinedError("Height");
    ...
    cropAndResize(image, width, height) {
        return this.size(image).then(size => {
            if (!image) throw new UndefinedError("Image");
            if (!size) throw new ErUndefinedErroror("Size");
            if (!width) throw new UndefinedError("Width");
            if (!height) throw new UndefinedError("Height");
    ...
    cropIfNeeded(image, width, height) {
        return this.size(image).then(size => {
            if (!image) throw new UndefinedError("Image");
            if (!size) throw new UndefinedError("Size");
            if (!width) throw new UndefinedError("Width");
            if (!height) throw new UndefinedError("Height");
