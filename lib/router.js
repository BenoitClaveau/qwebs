...
class Router {
    constructor($qwebs) {
        ...
        this.leafOptions = new Leaf(new Options()); //leaf to manage "*" for method OPTIONS
    };
    ...
    leaf(request) {
        switch (request.method) {
            ...
            case "OPTIONS":
                return this.assetTree.findOne(request.pathname) || this.getTree.findOne(request.pathname) || this.leafOptions;
            case "POST":
