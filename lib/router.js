            ...
            try {
                ...
                if (leaf) {
                    ...
                    if (!this.$qwebs.loaded) {
                        ...
                        reject(new DataError({ statusCode: 503, request: request, message: "Server is loading.", data: { url: request.url }, header: header }));
                    }
                ...
                reject(new DataError({ statusCode: 500, request: request, message: error.message, stack: error.stack }));
            }
        });
    };
};
