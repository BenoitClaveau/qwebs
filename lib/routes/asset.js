    ...
    constructor($qwebs, $config, route, contentType) {
        ...
        if (contentType) this.contentType = contentType;
            ...
            try {
                ...
                console.warn(error.message, error.data.extension, error.data.route);
            }
        };
    };
    ...
    initFromFiles(filepathList) {
        return Promise.resolve().then(() => {
            ...
            switch(this.contentType) {
                case "text/css": return this.getCssBundle(filepathList);
                case "application/javascript": return this.getJsBundle(filepathList);
                case "text/html": return this.getHtmlBundle(filepathList);
                case "application/json": return this.getBundle(filepathList, { ext: ".json", encoding: "utf8" });
                default: return this.getBundle(filepathList);
            }
        }).then(content => {
