    ...
    load() {
        return Promise.resolve().then(() => {
            ...
            routes.locators.forEach(locator => {
                if (locator.get) this.$qwebs.get(locator.get, locator.service, locator.method, locator.options);
                else if (locator.post) this.$qwebs.post(locator.post, locator.service, locator.method, locator.options);
                else if (locator.put) this.$qwebs.put(locator.put, locator.service, locator.method, locator.options);
                else if (locator.patch) this.$qwebs.patch(locator.patch, locator.service, locator.method, locator.options);
                else if (locator.delete) this.$qwebs.delete(locator.delete, locator.service, locator.method, locator.options);
