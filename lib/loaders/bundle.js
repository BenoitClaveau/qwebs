            ...
            try {
                ...
                return Q.ninvoke(fs, "readFile", filepath).then(function(str) {
                    try {
                        ...
                        throw new DataError({ message: "Failed to parse the bundle file.", data: { error: error.message, filepath: filepath }});
                    }
                });
            }
            catch(error) {
                throw new DataError({ message: "Failed to read the bundle file.", data: { error: error.message, filepath: filepath }});
            }
        }
