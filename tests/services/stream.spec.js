...
describe("stream", () => {
    ...
    //     request({ method: 'GET', uri: 'http://localhost:1338/stream-not-readable', json: true }, (error, response, body) => {
    //         expect(error).toBeNull();
    //         expect(body.length).toBe(2);
    //         expect(body[0].id).toBe(1);
    //         expect(body[1].id).toBe(2);
    ...
    //         expect(typeof body[0]).toBe("string");
    //         expect(typeof body[1].id).toBe(2);
    //         expect(typeof body[2]).toBe(33);
    //         done();
    //     });
    // });
    ...
    //     request({ method: 'GET', uri: 'http://localhost:1338/stream-error-after-sending', json: true }, (error, response, body) => {
    //         expect(error).toBeNull();
    //         expect(response.statusCode).toBe(500);
    //         expect(body.message).toBe("Error in stream.");
    //         done();
